...
app.use( "/assets" , express.static(path.join( __dirname , 'tmp/'))); // assigns a subdomain assets and stores files received in there to the directory received from dirname and further path ahead that is public/assets
